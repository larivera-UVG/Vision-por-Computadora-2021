...
###Scripts 
En la carpeta de códigos de [Matlab](José%20Ignacio%20Ramírez/Códigos/Matlab "Matlab"), se el archivo [CreadorCodigos.m](José%20Ignacio%20Ramírez/Códigos/Matlab/CreadorCodigos.m "CreadorCodigos.m") para generar los identificadores para los agentes. Aparte, se tiene el script [Pruebas.m](José%20Ignacio%20Ramírez/Códigos/Matlab/Pruebas.m "Pruebas.m") en el que se tiene separado por secciones los códigos de calibración, detección de obstáculos y toma de pose. Se puede utilizar el botón de **Run Section** para ejecutar únicamente el código requerido. Por ejemplo, luego de una calibración, ya no es necesario recalibrar a menos que se modifique el área de trabajo, por lo que se puede ejecutar únicamente el código de toma de pose.
