...
12/08/2020: Version 0.10.0 -- Modificaciones basadas en el codigo de Swarm_robotic.py, este codigo estaba pensado
                              para usarse inicialmente sin multi-hilos, con las modificaciones hechas ahora se
                              unifica para su uso con o sin multi-hilos.
                              Favor referirse a Swarm_robotic.py para las anotaciones completas del archivo original.
